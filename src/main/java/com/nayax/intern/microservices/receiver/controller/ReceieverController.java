...
public class ReceieverController {
    Logger logger = LoggerFactory.getLogger(ReceieverController.class);
    @Autowired
    ...
    @PostMapping("/events")
    public ResponseEntity<ResponseDto> addEvent(@RequestBody RequestDto requestDto) {
        ResponseWrapper<Long> responseWrapper = new ResponseWrapper<>();
