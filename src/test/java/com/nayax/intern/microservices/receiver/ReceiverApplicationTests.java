...
import com.nayax.intern.microservices.receiver.controller.ReceieverController;
...
class ReceiverApplicationTests {
    ...
    public void AddEvent() {
        ...
        RequestDto requestDto = new RequestDto(125, "CUSTOMER", b, "XLS");
    ...
    public void checkAddEventError() {
        byte[] b = new byte[20];
        new Random().nextBytes(b);
        Throwable exception_docType = Assert.assertThrows(IllegalArgumentException.class, () -> eventService.addEvent(new RequestDto(125, "CUSTOMER", b, "XLdS")));
        assertThat(exception_docType.getMessage().contains("enums.ContentTypeEnum"), CoreMatchers.is(true));
        Throwable exception_Customer = Assert.assertThrows(IllegalArgumentException.class, () -> eventService.addEvent(new RequestDto(125, "CUSTDOMER", b, "XLS")));
    ...
    public void createAndCheck() {
        byte[] b = new byte[20];
        new Random().nextBytes(b);
        RequestDto requestDto = new RequestDto(12115, "CUSTOMER", b, "XLS");
    ...
    public void checkSaveDocumentStatusDto() throws Exception {
        ...
        Long newId = eventService.addEvent(new RequestDto(12223, "CUSTOMER", b, "XLS"));
